          ...
          <div className="row justify-content-center">
            <div className="col-12 col-lg-3">
              <div className={styles.profile_list + " profile_list"}>
                <ul>
                  <li>
                    <NavLink to="/user/profile/editprofile">Edit Profile</NavLink>
                  </li>
                  <li>
                    <NavLink to="/user/profile/privacypolicy">Privacy Policy</NavLink>
                  </li>
                  <li>
                    <NavLink to="/user/profile/termsconditions">Terms & Conditions</NavLink>
                  </li>
                  <li>
                    <NavLink to="/user/profile/deleteaccount">Delete Account</NavLink>
                  </li>
                  <li>
